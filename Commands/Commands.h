...
namespace Commands
{
    ...
    const uint8_t PING_STATE = 0x07; //PING STATE, ALL
     ...
     const uint8_t PING_STATE_PACKET[7] = {0xAA, 0x14, 0xAC, 0x07, 0xAB, 0xAA};
     const uint8_t FILL_PACKET[7] = {0xAA, 0x14, 0xAC, 0x08, 0xAC, 0xAA};
    const uint8_t DISCONNECT_FILL_PACKET[7] = {0xAA, 0x14, 0xAC, 0x09, 0xDD, 0xDC};
    const uint8_t LAUNCH_PACKET[7] = {0xAA, 0x14, 0xAC, 0x10, 0xDE, 0xFE};
